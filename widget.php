            ...
            <div class="container" id="contact_form">
                <form name="contact" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
                  <fieldset>
                    ...
                    <input type="text" name="name" id="name" minlength="3" placeholder="Monty" class="text-input" minlength="3" required/>
                    </div>
                     
                    <div class="input-box">
                    <label for="email" id="email_label">Email</label>
                    <input type="email" name="email" id="email" placeholder="example@tutsplus.com" class="text-input" minlength="3"/>
                    </div>
                     
                    <div class="input-box">
                    <label for="phone" id="phone_label">Subject</label>
                    <input type="text" name="subject" id="subject" class="text-input" placeholder="subject"/>
                    </div>

                    <div class="input-box">
                    <label for="message" id="phone_label">Message</label>
                    <input type="textarea" name="message" id="message" class="text-input" style="width:500px; height: 200px;" placeholder="type your text"/>
                    </div>
    ...
    $( "form" ).on( "submit", function(e) {
            ...
            data: dataString,
                success: function () {
                    ...
                    // document.getElementById('call').innerHTML = "hello";
                }
            });
